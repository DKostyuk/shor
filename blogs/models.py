...
class BlogCategory(models.Model):
    ...
    code = models.SlugField(max_length=32, unique=False, null=True)
...
class Blog(models.Model):
    ...
    code = models.SlugField(max_length=128, unique=False, null=True)
    ...
    creator = models.ForeignKey(User, blank=True, null=True, default=None)
...
class BlogImage(models.Model):
    blog = models.ForeignKey(Blog, blank=True, null=True, default=None)
